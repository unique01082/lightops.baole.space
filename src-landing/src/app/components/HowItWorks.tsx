      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden md:block">
          <div className="relative">
            {/* Connecting line */}
            <div className="absolute top-6 left-0 right-0 h-0.5 bg-gradient-to-r from-violet-500/20 via-fuchsia-500/20 to-violet-500/20" />
                ...
                >
                  <div className="relative flex flex-col h-full">
                    ...
                    <div className="relative mb-6">
                      <div className="w-12 h-12 mx-auto bg-gradient-to-br from-violet-500 to-fuchsia-500 rounded-full flex items-center justify-center text-white text-4xl font-bold shadow-lg shadow-violet-500/30 transition-all duration-300 hover:scale-110 hover:shadow-xl hover:shadow-violet-500/50">
                        {step.number}
                      </div>
                    </div>
